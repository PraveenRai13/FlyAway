...
public class airlineList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet flList=(ResultSet) stmt.executeQuery("select Distinct Airline from flightlist");
		...
		while(flList.next()) {
			...
			if(j==1) {
				out.print("<html><body>");
				out.print("<div style='text-align: center'><h2>List of Airlines</h2></div>");
				...
				out.print(i+".");
				out.print("</td><td style='text-align: center' width='100 px'>");
				out.print(flList.getString("Airline")+"<br>");
				out.print("</td></tr>");
				out.print("</table>");
		...
		if(i==0) {
			out.print("<h2>No Airline available for ticket booking.</h2>");
		}
			out.print("<html><body>");
			...
			out.print("<h2>*No Airline available.</h2>");
			out.print("<html><body>");
